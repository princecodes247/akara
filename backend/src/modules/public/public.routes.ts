...
publicRouter.get("/projects/:id/ota/:currentSequence", publicController.getDesktopOtaUpdate);
publicRouter.get("/projects/:id/updates/ota/:currentSequence", publicController.getDesktopOtaUpdate);
